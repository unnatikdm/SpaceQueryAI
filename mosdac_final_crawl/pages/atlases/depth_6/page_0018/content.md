...
| [Display name![sort descending](https://mosdac.gov.in/misc/arrow-desc.png)](https://mosdac.gov.in/atlases?amp%3Border=modified&sort=desc&order=Display%20name "sort by Display name")| [size](https://mosdac.gov.in/atlases?amp%3Border=modified&sort=asc&order=size "sort by size")| [modified](https://mosdac.gov.in/atlases?amp%3Border=modified&sort=asc&order=modified "sort by modified")  
---|---|---|---  
| [Display name![sort descending](https://mosdac.gov.in/misc/arrow-desc.png)](https://mosdac.gov.in/atlases?amp%3Border=modified&sort=desc&order=Display%20name "sort by Display name")| [size](https://mosdac.gov.in/atlases?amp%3Border=modified&sort=asc&order=size "sort by size")| [modified](https://mosdac.gov.in/atlases?amp%3Border=modified&sort=asc&order=modified "sort by modified")  
---|---|---|---  
